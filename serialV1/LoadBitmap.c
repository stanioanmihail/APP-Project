...
* manipulation 
*/
Pixel** LoadBitmapFile(const char *filename, BitmapInfoHeader *bitmapInfoHeader, BitmapFileHeader *bfileHeader){
 ...
 * specific structures
*/
void SaveBitmapFile(const char *filename, BitmapInfoHeader *bitmapInfoHeader, BitmapFileHeader *bfileHeader, Pixel **pixelMatrix){
	FILE *bfilePtr;
	DWORD pIndex_x, pIndex_y;
