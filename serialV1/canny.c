...
int main(const int argc, const char ** const argv)
{
    ...
    char outfile[30];
    strcpy(outfile, "test_out.bmp");
    BitmapInfoHeader bmpInfoHeader;
    BitmapFileHeader bmpFileHeader; 
    Pixel** pixelMatrix = LoadBitmapFile(argv[1], &bmpInfoHeader, &bmpFileHeader);

	
    SaveBitmapFile(outfile, &bmpInfoHeader, &bmpFileHeader, pixelMatrix);  
   ...
   /* const pixel_t *out_bitmap_data =
    ...
    //if (save_bmp("out.bmp", &ih, in_bitmap_data)) {
